...
class SmallGraph extends React.Component {
    ...
    getOptions = () => {
        return { scales: this.adjustYAxisWithPercentage( this.props.input, 0.1) ,  responsive: true, plugins:{legend:{display:false}}
          }};


    render() {
        console.log(this.getOptions());
        return <Line data={this.state} options={this.getOptions()} />
    }
}
